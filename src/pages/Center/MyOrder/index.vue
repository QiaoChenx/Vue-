<template>
    <div class="order-right">
        <div class="order-content">
            ...
            <div class="orders">
                <table class="order-item" v-for="(order, index) of orderList" :key="order.id">
                    <thead>
                        <tr>
                            <th colspan="5">
            ...
            <div class="choose-order">
                <Pagination @changePage='getOrderList' :pageNo='page' :pageSize='limit' :total='total' :continues='3'></Pagination>
            </div>
            <!--猜你喜欢-->
            <div class="like">
                <h4 class="kt">猜你喜欢</h4>
