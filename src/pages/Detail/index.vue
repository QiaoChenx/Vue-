                ...
                <div class="InfoWrap">
                    ...
                    <div class="choose">
                        <div class="chooseArea">
                            ...
                            <dl
                                v-for="(saleAttr, index) of spuSaleAttrList"
                                :key="saleAttr.id"
                            >
                                <dt class="title">
                                ...
                                <dd
                                    ...
                                    v-for="(
                                        saleAttrValue, index
                                    ) of saleAttr.spuSaleAttrValueList"
...
export default {
    ...
    mounted() {
        this.$store.dispatch("detail/getDetailInfo", this.$route.params.id);
    },

    methods: {
        changeCheck(saleAttr, allSaleAttr) {
            allSaleAttr.forEach((item) => {
                item.isChecked = 0;
            });
            saleAttr.isChecked = 1;
        },
        changeNum() {
            let num = parseInt(this.skuNum.trim());
            if (isNaN(num) || num < 1) {
                this.skuNum = 1;
            }
            this.skuNum = num;
