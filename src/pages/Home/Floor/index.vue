                ...
                <div class="title clearfix">
                    ...
                    <div class="fr">
                        <ul class="nav-tabs clearfix">
                            <li  v-for="(navItem, index) of floorInfo.navList" :key="navItem.text">
                ...
                <div class="tab-content">
                    <div class="tab-pane">
                        <div class="floor-1">
                            <div class="blockgary">
                                <ul class="jd-list">
                                    <li v-for="(key, index) of floorInfo.keywords">{{key}}</li>
                                </ul>
                                <img :src="floorInfo.imgUrl" />
                            </div>
                            <div class="floorBanner">
                               <Carousel :carouselList='floorInfo.carouselList'></Carousel>
                            </div>
                            <div class="split">
