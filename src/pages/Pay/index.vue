    ...
    <div class="pay-main">
        <div class="pay-container">
            ...
            <div class="checkout-steps">
                ...
                <div class="submit">
                    <button @click="handlePay" class="btn">立即支付</button>
                </div>
                <div class="otherpay">
                    <div class="step-tit">
                        <h5>其他支付方式</h5>
...
export default {
    ...
    mounted() {
        this.$store.dispatch("pay/getPayInfo", this.$route.query.orderId);
    },
    computed: {
    ...
    methods: {
        async handlePay() {
            ...
            this.$alert(`<img src=${url} />`, "微信支付", {
                ...
                cancelButtonText: "支付出現問題",
                confirmButtonText: "已經支付成功",
